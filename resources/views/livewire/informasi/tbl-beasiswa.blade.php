<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3"></i>beasiswa</span>
                        </a>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <x-text-field type="text" name="nama_beasiswa" label="Nama Beasiswa" />
                    <x-text-field type="date" name="tanggal_beasiswa" label="Tanggal Beasiswa" />
                    <div wire:ignore class="form-group @error('deskripsi')has-error has-feedback @enderror">
