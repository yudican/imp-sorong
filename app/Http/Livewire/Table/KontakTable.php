...
class KontakTable extends LivewireDatatable
{
    protected $listeners = ['refreshTable'];
    public $hideable = 'select';
    public $table_name = 'tbl_kontak';
    public $hide = [];
...
Column::name('youtube')->label('Youtube')->searchable(),
Column::name('facebook')->label('Facebook')->searchable(),
Column::name('website')->label('Website')->searchable(),
    ...
    {
        $this->emit('getDataKontakById', $id);
    }

    public function getId($id)
    {
        $this->emit('getKontakId', $id);
    }
